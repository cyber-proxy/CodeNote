...
//        Binder.clearCallingIdentity();
        final long ident = 0;/*Binder.clearCallingIdentity();
*/
        for (;;) {
            ...
            final long newIdent = 0;/*Binder.clearCallingIdentity();*/
            if (ident != newIdent) {
...
//                        + msg.callback + " what=" + msg.what);
    ...
    public int postSyncBarrier() {
        return 0;/* mQueue.enqueueSyncBarrier(SystemClock.uptimeMillis());*/
    }
